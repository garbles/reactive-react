...
/***/ function(module, exports, __webpack_require__) {
	...
	var Mixin, asStream, assign, streamState, targetValue;

	assign = __webpack_require__(1);

	asStream = __webpack_require__(2);

	streamState = __webpack_require__(3);

	targetValue = __webpack_require__(4);

	Mixin = assign({}, asStream, streamState, targetValue);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function() {
	  var key, source, sources, target, _i, _j, _len, _len1, _ref;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AsStreamMixin, Bacon;

	Bacon = __webpack_require__(5);

	AsStreamMixin = {
	  asStream: function(fn) {
	    var bus, stream;
	    bus = new Bacon.Bus();
	    stream = fn(bus);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StreamStateMixin, _function, _string, _undefined,
	  __slice = [].slice;
	...
	StreamStateMixin = {
	  streamState: function(prop) {
	    var type;
	    type = typeof prop;
	    if (type === 'undefined' || type === 'function' || type === 'string') {
	      return _streamState[type].call(this, prop);
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TargetValueMixin;

	TargetValueMixin = {
	  targetValue: function(event) {
